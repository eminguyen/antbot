...
public class InviteCommand extends Command 
{
    ...
    /**Constructor for the invite command*/
    public InviteCommand() 
    {
        super("invite", "Sends an invite link for the bot");
    }
    ...
    {
        event.getChannel().sendMessage("https://discordapp.com/oauth2/authorize?client_id=390714926274183178&scope=bot"); 
    }
}
